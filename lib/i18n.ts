    ...
    patients: {
      ...
      alineadores: {
        ...
        items: [
          ...
          { title: "Limpieza", description: "Lavá los alineadores con cepillo suave y jabón neutro cada vez que los retires. Sumá una pastilla efervescente antibacteriana por día para mantenerlos limpios y transparentes. No uses agua caliente porque pueden deformarse. En el Instagram de Raquel (@od.rodriguezraquel) hay videos con más indicaciones sobre el uso." },
