  ...
  es: {
    ...
    patients: {
      ...
      brackets: {
        ...
        items: [
          { title: "Alimentos a evitar", description: "Evitá alimentos duros (caramelos, almendras, maní, hielo — los peores), pegajosos (chicles, caramelos masticables) y morder con los dientes delanteros (manzana entera, choclo). Cortá los alimentos en trozos pequeños." },
          { title: "Higiene", description: "Cepillá después de cada comida con un cepillo de cabeza pequeña y cerdas suaves (también podés usar un cepillo específico para ortodoncia). Usá cepillos interdentales para limpiar alrededor de los brackets. El hilo dental (hilo para ortodoncia) con enhebrador es fundamental." },
          ...
          { title: "Si se despega un bracket", description: "No te alarmes. Si no molesta, podés esperar hasta tu próximo turno — en ese caso, guardá el bracket y llevalo para que lo volvamos a colocar. Si pincha o molesta, cubrí con cera y contactanos." },
      ...
      alineadores: {
        ...
        items: [
          ...
          { title: "Cómo colocarlos y retirarlos", description: "Colocá presionando con los dedos, nunca mordiendo. Para retirar, empezá por la parte posterior de ambos lados. En el kit inicial te damos un palito extractor (herramienta con ganchito que ayuda a retirar los alineadores) y chewies (gomitas que mejoran la adaptación del alineador, sobre todo al cambiar de placa)." },
          { title: "Cómo guardarlos", description: "Cuando retires los alineadores de la boca, guardalos siempre en su estuche. Los mantiene seguros, evita que se deformen y que los pierdas (son transparentes y se confunden fácil). En el kit inicial te damos el estuche." },
          { title: "Limpieza", description: "Los alineadores son de plástico: limpialos siempre con agua fría, nunca caliente. Usá un cepillo de cabeza pequeña y cerdas suaves para no dañarlos. Sumá pastillas efervescentes antibacterianas una vez por día: ponelas en un vasito con agua fría, dejá el alineador 3 a 5 minutos, enjuagá, cepillá y ya está listo para volver a usar. Esto los mantiene transparentes y sin manchas por más tiempo. En el Instagram de Raquel (@od.rodriguezraquel) podés ver el paso a paso en video." },
          { title: "Si se rompe uno", description: "Contactanos inmediatamente. Podés enviarnos una foto del alineador y te indicamos qué hacer. Mientras tanto, usá el alineador anterior hasta que te confirmemos los pasos." },
          ...
          { title: "Uso de elásticos", description: "Si te indicamos el uso de elásticos, es fundamental cumplir con las horas indicadas para que el tratamiento avance correctamente. Prestá atención a dónde van colocados y qué tipo tenés que usar, porque pueden ir cambiando durante el tratamiento." },
          { title: "Si perdés el alineador", description: "Contactanos inmediatamente. Hay dos opciones: si cambiaste hace pocos días, volvé al alineador anterior. Si te faltan pocos días (2-3) para pasar al siguiente, probá directamente con el alineador siguiente." },
          { title: "Si se despega un atache", description: "No te preocupes, seguí usando tu alineador con normalidad. En el próximo control avisanos para volver a colocarlo." },
        ],
      },
      ortopedia: {
        ...
        items: [
          ...
          { title: "Adaptación", description: "Los primeros días puede generar molestias leves, aumento de salivación y cambios en el habla. Todo esto es normal y mejora rápidamente." },
          { title: "Limpieza (aparato fijo)", description: "Si el aparato está adherido a los dientes, la limpieza es igual que el cepillado habitual, pero haciendo más hincapié en el aparato para evitar la acumulación de bacterias." },
          { title: "Limpieza (aparato removible)", description: "Los aparatos removibles son los que se ponen y se sacan de la boca. Limpialos diariamente con cepillo y jabón neutro, y guardalos siempre en su estuche cuando no los uses." },
          { title: "Controles", description: "No faltes a los controles programados. Son fundamentales para lograr avances en tu tratamiento y que finalices en el tiempo programado." },
